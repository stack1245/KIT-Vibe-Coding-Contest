...
const globalSessionSecrets = globalThis;

if (!globalSessionSecrets.__phaseEphemeralSessionSecret) {
  globalSessionSecrets.__phaseEphemeralSessionSecret = crypto.randomBytes(32).toString('hex');
}
...
function getSessionSecret() {
  ...
  return globalSessionSecrets.__phaseEphemeralSessionSecret;
}
